...
mongoose.promise=Promise;//mongoose.Promise = global.Promise;
...
nev.configureAsync({
  ...
  verificationURL: 'http://139.59.78.201:9000/email-verification/${URL}',
  transportOptions: {
    service: 'Gmail',
    auth: {
...
app.post('/signup', function(req, res) {
  ...
  //if (req.body.type === 'register') {
	...
	console.log('User already in temporary collection');      
}
    })
    .then(function(info) {
      res.json({
